---
title: 'CSSS508: Introduction to R for Social Scientists'
subtitle: "University of Washington"
author: "[Charles Lanfear](mailto:clanfear@uw.edu)"
date: "Autumn 2017"
...
finding answers much easier. To use the mailing list, send your email to `cs_ss508a_au17@uw.edu`
...
through the beginning of Winter term, so you may review and work on them after the course has ended. 
If you are registered for the course and did not receive a DataCamp email by Wednesday 9/27/17, please [email the instructor](mailto:clanfear@uw.edu).

[Tutorial Package](https://github.com/clanfear/CSSS508/raw/master/uwcsss508_0.1.0.zip)

This course also features an R package containing optional interactive tutorials for practicing
concepts from lecture. These short tutorials are useful to check your understanding
but are not required. The package is in an early stage of development, so please email
me if you find bugs or problems. Installation instructions are found in the Week 1 slides.
...
the last two weeks reserved for topics requested by students.
