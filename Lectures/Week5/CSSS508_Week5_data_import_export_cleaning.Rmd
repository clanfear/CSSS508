...
date: "Apr 28, 2021<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
* What are the values?
    ...
    + Gender: Woman, Man -- **in the column headings, not its own column!**
...
|-----------------|-----------:|---------:|
| Evans School    |     Woman |    10   |
| Evans School    |     Man   |    6    |
| Arts & Sciences |     Woman |    5    |
| Arts & Sciences |     Man   |    6    |
| Public Health   |     Woman |    2    |
| Public Health   |     Man   |    3    |
| Other           |     Woman |    5    |
| Other           |     Man   |    1    |
