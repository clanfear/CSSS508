...
date: "Apr 10, 2019<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
.footnote[Add a scatterplot of large red points.]
---
count: false
...
.footnote[Pick a theme and increase the text size.]
---
