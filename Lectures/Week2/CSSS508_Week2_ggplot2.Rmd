...
.center[
<img src="https://github.com/clanfear/CSSS508/raw/master/Lectures/Week2/CSSS508_Week2_GGPlot2-figure/ggplot2unit.jpg" style="width: 70%;"/>
]
...
Layers are separated by a `+` sign. For clarity, I usually put each layer on a new line, unless it takes few or no arguments (e.g. `xlab()` and `ylab()`).
