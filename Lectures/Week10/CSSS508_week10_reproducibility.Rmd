...
For research to be reproducible, it must also be *portable*. Portable software operates *independent of workflow* such as fixed file locations.
...
I find it beneficial to break projects into *many* files:
   ...
   * Scripts to load each set of variables.
   * Scripts to run each set of models.
   * Scripts to make tables and plots.
