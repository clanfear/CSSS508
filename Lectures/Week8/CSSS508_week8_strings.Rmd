...
date: "Nov 14, 2018<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
Here are some examples; make sure you understand how the arguments produce the results:
