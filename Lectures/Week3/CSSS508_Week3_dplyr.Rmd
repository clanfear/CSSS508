...
date: "Apr 15, 2020<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
`dplyr` 1.0.0 will be released very soon.

Nothing you've learned will suddenly disappear, but new approaches will be introduced--and eventually become the primary way to do things.

These links provide examples of important changes and features.

* [`dplyr` 1.0.0 overview](https://www.tidyverse.org/blog/2020/03/dplyr-1-0-0-is-coming-soon/)
* [New `summarize()` features](https://www.tidyverse.org/blog/2020/03/dplyr-1-0-0-summarise/)
* [`select()`, `rename()`, and `relocate()`](https://www.tidyverse.org/blog/2020/03/dplyr-1-0-0-select-rename-relocate/)
* [Working `across()` multiple columns](https://www.tidyverse.org/blog/2020/04/dplyr-1-0-0-colwise/)
   + Supersedes `_at()`, `_if()`, and `_all()` versions of `mutate()` and `summarize()`
* [`rowwise()` operations](https://www.tidyverse.org/blog/2020/04/dplyr-1-0-0-rowwise/)
