...
mono_accent(base_color = "#342c5c",
            ...
            title_slide_background_image = "https://raw.githubusercontent.com/clanfear/CSSS508/master/Lectures/Week1/img/CherryBlossoms_42-X3_crop.png",
...
If you want to take notes directly on the slides, you can **Print to PDF**.
...
1. Press Ctrl+P
2. Change *Destination* to *Microsoft Print to PDF*
3. Press Print to Save as PDF
]
...
1. File > Print
2. Select PDF in lower left
3. Save as PDF
]

If you want to see the code used to generate these slides, you can right click on the slide and select *View Page Source*<sup>1</sup> 

.footnote[
[1] In Chrome on Windows anyway.
]
...
*Italics* indicate emphasis but also are used to point out thinks you must click with a mouse, for example: "Please click *File > Print*"
...
\* *Optional topics*: We will do **two**. A video from 2017 will be available for 
the third. If you miss any lecture, videos of lectures are available
...
than vague ones*! Good names<sup>1</sup> save confusion later.
...
[2] Here be dragons! LaTeX is like a wizard with dementia: Terribly powerful but incomprehensible.
]
...
`hist()` generates a histogram of a vector.
