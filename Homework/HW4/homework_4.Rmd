...
# 9)  Then use rbind() to add the rows from mat_3 to this (mat_3 first, mat_t second_ and assign this combination to mat_big.
mat_big <- NULL
...
# 3) Combine list_1 and list_2 together using "c()" and assign them to "list_3"
list_3 <- NULL
