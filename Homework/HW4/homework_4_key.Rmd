...
1) Fill in **code** as needed in the designated locations in code chunks.
    ...
    + Where you are assigning things to objects, replace the "NULL" values with your code.
...
```{r example_1}
# Ex) Create a vector of the numbers 1, 5, 3, 2, 4.
example <- NULL
...
# 4) Create a new data frame "df_3"" using data.frame() that contains the following named colums (in order):
...
df_4 %>% ggplot(aes(x, y, color=color)) + geom_point() + theme(legend.position="none")
